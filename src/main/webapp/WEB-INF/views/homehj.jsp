...
<link rel="stylesheet" type="text/css" href="/css/classy-nav.css">
...
<body>
	...
	<header class="header-area">
						...
						<div class="breaking-news-area">
							<div id="breakingNewsTicker" class="ticker" style="height: 24px;">
								<ul>
									...
									<li class="tickerHook"
										style="top: 0px; left: 0px; position: absolute; display: block; opacity: 1; z-index: 99;"><a
										href="#">Hello Colorlib!</a></li>
									<li class=""
										style="top: -3em; left: 0px; position: absolute; display: block; opacity: 0; z-index: 98;"><a
										href="#">Hello World!</a></li>
									<li class=""
										style="top: -3em; left: 0px; position: absolute; display: block; opacity: 0; z-index: 98;"><a
										href="#">Hello Universe!</a></li>
									<li class=""
										style="top: -3em; left: 0px; position: absolute; display: block; opacity: 0; z-index: 98;"><a
										href="#">Hello Original!</a></li>
									<li class=""
										style="top: -3em; left: 0px; position: absolute; display: block; opacity: 0; z-index: 98;"><a
										href="#">Hello Earth!</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-12 col-sm-4">
						<div class="top-social-area">
							<a href="#" data-toggle="tooltip" data-placement="bottom"
								title="" data-original-title="Pinterest"><i
								class="fa fa-pinterest" aria-hidden="true"></i></a> <a href="#"
								data-toggle="tooltip" data-placement="bottom" title=""
								data-original-title="Facebook"><i class="fa fa-facebook"
								aria-hidden="true"></i></a> <a href="#" data-toggle="tooltip"
								data-placement="bottom" title="" data-original-title="Twitter"><i
								class="fa fa-twitter" aria-hidden="true"></i></a> <a href="#"
								data-toggle="tooltip" data-placement="bottom" title=""
								data-original-title="Dribbble"><i class="fa fa-dribbble"
								aria-hidden="true"></i></a> <a href="#" data-toggle="tooltip"
								data-placement="bottom" title="" data-original-title="Behance"><i
		...
		<div id="stickyNav-sticky-wrapper" class="sticky-wrapper"
			style="height: 100px;">
			<div class="original-nav-area" id="stickyNav" style="width: 1024px;">
							...
							<div class="classy-menu" id="originalNav">
								...
								<div class="classynav">
									<ul>
										...
										<li class="cn-dropdown-item has-down pr12"><a href="#">Pages</a>
											<ul class="dropdown">
												<li><a href="index.html">Home</a></li>
											...
											</ul> <span class="dd-trigger"></span><span class="dd-arrow"></span></li>
										<li class="cn-dropdown-item has-down pr12"><a href="#">Catagory</a>
											<ul class="dropdown">
												<li><a href="#">Catagory 1</a></li>
												<li><a href="#">Catagory 1</a></li>
												<li class="has-down"><a href="#">Catagory 1</a>
													<ul class="dropdown">
														<li><a href="#">Catagory 2</a></li>
														<li><a href="#">Catagory 2</a></li>
														<li class="has-down"><a href="#">Catagory 2</a>
															<ul class="dropdown">
										...
										<li><a href="about-us.html">About Us</a></li>
										<li class="megamenu-item"><a href="#">Megamenu</a>
											<div class="megamenu">
											...
											</div> <span class="dd-trigger"></span><span class="dd-arrow"></span></li>
										<li><a href="contact.html">Contact</a></li>
									</ul>
	...
	<div class="hero-area">
		...
		<div class="hero-slides owl-carousel owl-theme owl-center owl-loaded">
			...
			<div class="owl-stage-outer">
				<div class="owl-stage"
					style="transition: 2s; width: 3689px; transform: translate3d(-1844.5px, 0px, 0px);">
					<div class="owl-item cloned"
						style="width: 497px; margin-right: 30px;">
								...
								<div class="row h-100 align-items-center">
									<div class="col-12">
										<div class="slide-content text-center">
											<div class="post-tag">
												<a href="#" data-animation="fadeInUp" style="opacity: 0;">lifestyle</a>
											</div>
											<h2 data-animation="fadeInUp" data-delay="250ms"
												style="animation-delay: 250ms; opacity: 0;">
					...
					<div class="owl-item" style="width: 497px; margin-right: 30px;">
						<div class="single-hero-slide bg-img"
							...
							<div class="container h-100">
								<div class="row h-100 align-items-center">
									<div class="col-12">
										<div class="slide-content text-center">
											<div class="post-tag">
												<a href="#" data-animation="fadeInUp" style="opacity: 0;"
													class="">lifestyle</a>
											</div>
											<h2 data-animation="fadeInUp" data-delay="250ms"
												style="animation-delay: 250ms; opacity: 0;" class="">
												<a href="single-post.html">Take a look at last night’s
													party!</a>
											</h2>
										</div>
			...
			<div class="row">
				<div class="col-12 col-lg-9">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						style="visibility: visible; animation-duration: 1000ms; animation-delay: 0.2s; animation-name: fadeInUp;">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						style="visibility: visible; animation-duration: 1000ms; animation-delay: 0.3s; animation-name: fadeInUp;">
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						style="visibility: visible; animation-duration: 1000ms; animation-delay: 0.4s; animation-name: fadeInUp;">
						<div class="row">
							<div class="col-12">
								<div class="single-blog-thumbnail">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						style="visibility: hidden; animation-duration: 1000ms; animation-delay: 0.5s; animation-name: none;">
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
					...
					<div class="single-blog-area blog-style-2 mb-50 wow fadeInUp"
						...
						style="visibility: hidden; animation-duration: 1000ms; animation-delay: 0.6s; animation-name: none;">
						<div class="row align-items-center">
							<div class="col-12 col-md-6">
								<div class="single-blog-thumbnail">
					...
					<div class="load-more-btn mt-100 wow fadeInUp"
						...
						style="visibility: hidden; animation-duration: 1000ms; animation-delay: 0.7s; animation-name: none;">
						<a href="#" class="btn original-btn">Read More</a>
					</div>
				</div>
	...
	<div class="instagram-feed-area">
		...
		<!-- Instagram Slides -->
		<div class="instagram-slides owl-carousel owl-theme owl-loaded">
			<!-- Single Insta Feed -->
			...
			<div class="owl-stage-outer">
				<div class="owl-stage"
					style="transform: translate3d(-1843.2px, 0px, 0px); transition: 2s; width: 3481.6px;">
					<div class="owl-item cloned"
						style="width: 204.8px; margin-right: 0px;">
					...
					<div class="owl-item" style="width: 204.8px; margin-right: 0px;">
						<div class="single-insta-feed">
	...
	<footer class="footer-area text-center">
				...
				<div class="col-12">
					...
					<div class="footer-social-area mt-30">
						<a href="#" data-toggle="tooltip" data-placement="top" title=""
							...
							data-original-title="Twitter"><i class="fa fa-twitter"
							aria-hidden="true"></i></a> <a href="#" data-toggle="tooltip"
							data-placement="top" title="" data-original-title="Dribbble"><i
							class="fa fa-dribbble" aria-hidden="true"></i></a> <a href="#"
							data-toggle="tooltip" data-placement="top" title=""
							data-original-title="Behance"><i class="fa fa-behance"
							aria-hidden="true"></i></a> <a href="#" data-toggle="tooltip"
		...
		2018 All rights reserved | This template is made with <i
	...
	<a id="scrollUp" href="#top"
		style="position: fixed; z-index: 2147483647; display: none;">Top</a>
